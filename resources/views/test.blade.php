...
@section('content')
    <div class="container-fluid firework">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <p style="font-family:dk_lemon_yellow_sun_regular; font-size:40px; text-align: center">Ready for testing
                your wisdom? Well, buckle up champ, here are 10 pictures!</p>
                <div class="card mx-auto" id="animal_card" style="width:{{$animal->width}}px;">
                    <img class="card-img-top center" id="animal_img" src="img/{{$animal->filename}}"
                         style="width:{{$animal->width}}px;height:{{$animal->height}}px">
                    <div class="card-body">
            ...
            $.post("animal/check", {name: $('#animal_name').val(), id: $('#animal_id').val()}, function (data) {
                ...
                if (parseInt($('#animal_overall').val()) <= 10) {
                    ...
                    $.post("save/score", {score: parseInt($('#animal_right').val()) * 10}, function (data) {
                        ...
                        $('.col-md-8').append('<div style="background:transparent !important" class="jumbotron jumbotron-fluid">\n' +
                            '                    <div class="container">\n' +
                            '                        <h1 class="display-4">Congratulations!</h1>\n' +
                            '                        <p class="lead ml-4">You reached ' + parseInt(data.score) + ' points!</p>\n' +
                            '                    </div>\n' +
                            '                </div>');
                        $(".firework").fireworks();
                        jQuery(".firework").before(jQuery("canvas")); //this makes the canvas appear behind the example text
                    })
                }
